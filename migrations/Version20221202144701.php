...
final class Version20221202144701 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pilote (id INT AUTO_INCREMENT NOT NULL, qualification_id INT DEFAULT NULL, nom VARCHAR(64) NOT NULL, email VARCHAR(255) NOT NULL, prenom VARCHAR(64) NOT NULL, INDEX IDX_6A3254DD1A75EE38 (qualification_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
